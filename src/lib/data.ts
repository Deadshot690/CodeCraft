...
export const battleQuestions: BattleQuestion[] = [
    ...
    { id: 'bq8', "question": "In CSS, what property is used to change the text color of an element?", "answer": "color", "difficulty": "Beginner", "xp": 15, "category": "CSS" },
    { id: 'bq9', "question": "What is the command to initialize a new Git repository?", "answer": "git init", "difficulty": "Beginner", "xp": 20, "category": "Git" },
    ...
    { id: 'bq12', "question": "In Java, what keyword is used to create a new instance of a class?", "answer": "new", "difficulty": "Beginner", "xp": 20, "category": "Java" },
    ...
    { id: 'bq15', "question": "What is the process of a function calling itself called?", "answer": "Recursion", "difficulty": "Intermediate", "xp": 25, "category": "Concepts" },
    { id: 'bq16', "question": "In React, what hook is used to perform side effects in function components?", "answer": "useEffect", "difficulty": "Intermediate", "xp": 30, "category": "React" },
    { id: 'bq17', "question": "What type of join in SQL returns all rows when there is a match in either table?", "answer": "FULL OUTER JOIN", "difficulty": "Advanced", "xp": 45, "category": "SQL" },
    { id: 'bq18', "question": "In object-oriented programming, what is the term for bundling data and methods together?", "answer": "Encapsulation", "difficulty": "Intermediate", "xp": 30, "category": "OOP" },
    { id: 'bq19', "question": "What is the main purpose of a constructor in a class?", "answer": "To initialize an object", "difficulty": "Beginner", "xp": 20, "category": "OOP" },
    { id: 'bq20', "question": "What is the name of the algorithm that finds the shortest path in a weighted graph?", "answer": "Dijkstra's algorithm", "difficulty": "Advanced", "xp": 50, "category": "Algorithms" },
    { id: 'bq21', "question": "Which design pattern provides a single point of access to a particular instance of a class?", "answer": "Singleton", "difficulty": "Advanced", "xp": 40, "category": "Design Patterns" },
    { id: 'bq22', "question": "What does 'VM' stand for in the context of cloud computing?", "answer": "Virtual Machine", "difficulty": "Beginner", "xp": 15, "category": "Cloud" },
    { id: 'bq23', "question": "In Python, what is a decorator?", "answer": "A function that modifies another function", "difficulty": "Advanced", "xp": 50, "category": "Python" },
    ...
    { id: 'bq25', "question": "What principle is represented by the 'I' in SOLID?", "answer": "Interface Segregation", "difficulty": "Expert", "xp": 65, "category": "OOP" },
    { id: 'bq26', "question": "Which Python library is commonly used for data manipulation and analysis?", "answer": "pandas", "difficulty": "Intermediate", "xp": 30, "category": "Python" },
    { id: 'bq27', "question": "In Git, what is the command to create and switch to a new branch?", "answer": "git checkout -b", "difficulty": "Intermediate", "xp": 30, "category": "Tools" },
    { id: 'bq28', "question": "What type of attack involves tricking a user into executing unwanted actions on a web application in which they're currently authenticated?", "answer": "CSRF", "difficulty": "Advanced", "xp": 50, "category": "Cybersecurity" },
    { id: 'bq29', "question": "Which algorithm is used by Google to rank pages?", "answer": "PageRank", "difficulty": "Expert", "xp": 70, "category": "Algorithms" },
    ...
    { id: 'bq31', "question": "In CSS Flexbox, what property aligns items along the main axis?", "answer": "justify-content", "difficulty": "Intermediate", "xp": 30, "category": "Web Development" },
    { id: 'bq32', "question": "What does the `===` operator check for in JS?", "answer": "value and type", "difficulty": "Beginner", "xp": 20, "category": "JavaScript" },
    { id: 'bq33', "question": "What SQL join returns all records from the left table and matched records from the right?", "answer": "LEFT JOIN", "difficulty": "Intermediate", "xp": 30, "category": "Databases" }
];
