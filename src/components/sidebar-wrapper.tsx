...
export default function SidebarWrapper() {
  ...
  return (
    <>
      ...
      <header className="flex h-14 items-center gap-4 border-b bg-background/95 backdrop-blur-sm px-4 lg:h-[60px] lg:px-6 sticky top-0 z-30 peer-data-[variant=inset]:ml-[var(--sidebar-width)] peer-data-[collapsible=icon]:peer-data-[variant=inset]:ml-[calc(var(--sidebar-width-icon)_+_1rem)] peer-data-[variant=sidebar]:ml-[var(--sidebar-width)] peer-data-[collapsible=icon]:peer-data-[variant=sidebar]:ml-[var(--sidebar-width-icon)]">
