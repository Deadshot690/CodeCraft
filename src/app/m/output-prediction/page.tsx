...
import { BrainCircuit, Languages, CheckCircle, Loader2 } from "lucide-react";
...
function ChallengeRow({ challenge, isSolved }: { challenge: OutputPredictionChallenge, isSolved: boolean }) {
    return (
        <TableRow>
